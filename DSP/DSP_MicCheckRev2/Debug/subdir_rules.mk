...
build-348952479:
	@$(MAKE) -Onone -f subdir_rules.mk build-348952479-inproc

build-348952479-inproc: ../app.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-348952479 ../app.cfg
configPkg/compiler.opt: build-348952479
configPkg/: build-348952479
