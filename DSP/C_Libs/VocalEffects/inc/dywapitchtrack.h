...
/* Usage
 ...
 float thepitch = dywapitch_computepitch(&pitchtracker, samples, start, count);
...
float dywapitch_computepitch(dywapitchtracker *pitchtracker, float * restrict samples, int startsample, int samplecount);
